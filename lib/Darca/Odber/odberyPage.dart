      ...
      body: SafeArea(
        child: ListView.builder(
          ...
          itemBuilder:(context, index) {
            odber odb1=new odber(userOdberyListDisplay[index]['idDarca'],userOdberyListDisplay[index]['mnozstvo'],userOdberyListDisplay[index]['datum'],userOdberyListDisplay[index]['typ'],userOdberyListDisplay[index]['autoodber'],userOdberyListDisplay[index]['komplikacia'],userOdberyListDisplay[index]['koniec'],userOdberyListDisplay[index]['tlakkrvi'],userOdberyListDisplay[index]['vyjazd'],userOdberyListDisplay[index]['zaciatok'],userOdberyListDisplay[index]['trvanie']);
