        ...
        body: Theme(
          ...
          child: ListView.builder(
              ...
              itemBuilder:(context, index) {
                ...
                mobilnaOC moc=new mobilnaOC(_vyjazdoveOC.listMobilnychOC[index]['cas'],_vyjazdoveOC.listMobilnychOC[index]['datum'].toString(),_vyjazdoveOC.listMobilnychOC[index]['mapy'],_vyjazdoveOC.listMobilnychOC[index]['miesto'],_vyjazdoveOC.listMobilnychOC[index]['oc']);
