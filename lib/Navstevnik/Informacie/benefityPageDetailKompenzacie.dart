...
class benefityPageDetailKompenzacie extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Zákonom určené kompenzácie"),
